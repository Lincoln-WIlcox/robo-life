...
@export var power_pole_selection_map_entity: SelectableMapEntity
...
func _on_power_pole_selection_map_entity_setup(map_entity: SelectableMapEntity) -> void:
...
func make_selectable_power_pole_map_entity() -> SelectableMapEntity:
	var new_map_entity: SelectableMapEntity = power_pole_selection_map_entity.duplicate()
